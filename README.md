...
<img src="https://readme-typing-svg.demolab.com?font=Fira+Code&size=22&duration=3000&pause=1000&color=00D9FF&center=true&vCenter=true&width=600&lines=Data+Engineering+Intern+%40+Lumiq;Big+Data+%7C+Distributed+Systems+%7C+Cloud;Real-Time+Pipelines+with+Kafka+%26+Spark;Open+to+Data+Engineering+Opportunities!" alt="Typing SVG" />
...
> End-to-end streaming pipeline processing live crypto data

- 📡 **Binance WebSocket** — Live price feeds
- 🔄 **Apache Kafka** — Message brokering
- ⚡ **PySpark Structured Streaming** — Real-time processing
- 🗄️ **PostgreSQL + Parquet** — Data warehouse & lake
- 📊 **Grafana** — Live dashboards
- 🐳 **Docker** — Containerized deployment

[![Repo](https://img.shields.io/badge/View%20Repo-181717?style=for-the-badge&logo=github)](https://github.com/rishikesh8pandey/real_time_crypto_analytics_platform)

</td>
<td width="50%">

### 🏭 FMCG Data Engineering Project
> Scalable batch pipeline using Medallion Architecture
...
[![Repo](https://img.shields.io/badge/View%20Repo-181717?style=for-the-badge&logo=github)](https://github.com/rishikesh8pandey)
...
*"Turning real-time data streams into actionable insights, one pipeline at a time."* ⚡
